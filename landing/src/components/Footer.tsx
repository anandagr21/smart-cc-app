        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-9 h-9 rounded-xl bg-white/10 p-0.5 shadow-lg shadow-brand-500/20"><img src="/favicon.png" alt="Card Analyser" className="w-full h-full rounded-lg" /></div>
