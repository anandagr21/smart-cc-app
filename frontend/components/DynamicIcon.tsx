...
import {
  Activity, AlertCircle, AlertTriangle, ArrowDown, ArrowLeft, ArrowLeftRight, ArrowRight, ArrowUpRight, BarChart, BarChart3, Bell, BellRing, BookOpen, Bot, BrainCircuit, Building2, Calendar, Car, Check, CheckCircle, CheckCircle2, CheckSquare, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Clock, Coffee, Compass, Cpu, CreditCard, Database, Edit2, FileText, Film, Filter, Fingerprint, Focus, FolderKanban, Fuel, Gift, GitCommit, Globe, HeartPulse, HelpCircle, History, Home, House, IndianRupee, Info, Layers, LayoutList, Lightbulb, Link, ListChecks, Lock, LogOut, Mail, MapPin, Maximize, MessageSquare, MessageSquareWarning, Monitor, Moon, Network, Pencil, Plane, PlayCircle, Plus, Receipt, RefreshCw, Rocket, Scale, Search, Settings, Shield, ShieldAlert, ShieldCheck, ShoppingBag, ShoppingCart, SlidersHorizontal, Smartphone, Sparkles, Store, Sun, Tag, Target, Trash2, TrendingUp, Trophy, UploadCloud, User, Utensils, Wallet, Wifi, X, Zap,
  Circle, LucideIcon,
...
const ICON_REGISTRY: Record<string, IconComponent> = {
  Activity, AlertCircle, AlertTriangle, ArrowDown, ArrowLeft, ArrowLeftRight, ArrowRight, ArrowUpRight, BarChart3, Bell, BellRing, BookOpen, Bot, BrainCircuit, Building2, Calendar, Car, Check, CheckCircle, CheckCircle2, CheckSquare, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Clock, Coffee, Compass, Cpu, CreditCard, Database, Edit2, FileText, Film, Filter, Fingerprint, Focus, FolderKanban, Fuel, Gift, GitCommit, Globe, HeartPulse, HelpCircle, History, Home, House, IndianRupee, Info, Layers, LayoutList, Lightbulb, Link, ListChecks, Lock, LogOut, Mail, MapPin, Maximize, MessageSquare, MessageSquareWarning, Monitor, Moon, Network, Pencil, Plane, PlayCircle, Plus, Receipt, RefreshCw, Rocket, Scale, Search, Settings, Shield, ShieldAlert, ShieldCheck, ShoppingBag, ShoppingCart, SlidersHorizontal, Smartphone, Sparkles, Store, Sun, Tag, Target, Trash2, TrendingUp, Trophy, UploadCloud, User, Utensils, Wallet, Wifi, X, Zap,
  // Aliases
  BarChart2: BarChart3,
  BarChart: BarChart3,
