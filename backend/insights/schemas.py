...
class InsightResponse(BaseModel):
    ...
    related_card_id: Optional[str] = Field(None, description="UUID of the related UserCard")
    
    # Financial impact
    monetary_value: Optional[float] = Field(None, description="Monetary delta or target amount")
    
    # Actionable payload
    recommended_action: Optional[Dict[str, Any]] = Field(
